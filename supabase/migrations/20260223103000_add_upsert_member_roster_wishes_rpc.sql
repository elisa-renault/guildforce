-- Allow wish managers to edit any member wishes/commitment on an unlocked roster they can access.
...
BEGIN
  ...
  IF NOT public.can_edit_wishes(p_guild_id, p_roster_id, p_member_id) THEN

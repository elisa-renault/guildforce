-- In private wish seasons, regular members should not receive other roster rows
-- from the roster season table RPC. They are redirected to their personal wish page.

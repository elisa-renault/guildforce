-- Modifier la fonction log_wish_activity pour gérer la suppression de compte
...
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    SELECT EXISTS(SELECT 1 FROM profiles WHERE id = OLD.user_id) INTO v_user_exists;

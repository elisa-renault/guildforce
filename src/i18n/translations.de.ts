...
export const translationsDe: Translations = createLocaleTranslations(translationsEn, {
  ...
  "dashboard": {
    ...
    "classesRepresented": "Vertretene Klassen",
    "requestedSpecializations": "Gewünschte Spezialisierungen",
    "lootConcentrationRisk": "Loot-Konzentrationsrisiko",
    "tokenRiskLevels": {
    ...
    "coverageSourceState": "{{count}} Quelle · {{state}}",
    "coverageSourceStatePlural": "{{count}} Quellen · {{state}}",
    "coverageSourceCount": "{{count}} Quelle",
    "coverageSourceCountPlural": "{{count}} Quellen",
    "coverageStates": {
      "missing": "Fehlt",
      "covered": "Abgedeckt",
      "secured": "Gesichert"

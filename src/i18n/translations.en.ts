...
export const translationsEn: Translations = {
    ...
    demo: {
      title: 'Public Roster Wishlist Demo',
      eyebrow: 'Sample guild workspace',
      subtitle: 'See how officers collect class/spec wishes, review a roster, and spot what the raid team is missing before connecting Battle.net.',
      exploreCta: 'Explore the demo',
      noLoginRequired: 'No Battle.net login required.',
      landingSubtitle: 'Explore a sample roster, wishlist, analytics, polls, and officer workflows before connecting Battle.net.',
      authPromptTitle: 'Not ready to connect Battle.net?',
      authPromptDescription: 'Try the public roster wishlist demo first.',
      authPromptCta: 'Try the demo',
      bannerTitle: 'Demo mode',
      bannerDescription: 'You are exploring a sample guild. Connect Battle.net to sync your own characters and guild.',
      bannerCta: 'Create my guild workspace',
      nav: {
        overview: 'Overview',
      ...
      labels: {
        guild: 'Guild',
        roster: 'Roster',
        lock: 'Wishlist locks in {{days}} days',
        submitted: 'Wishes submitted',
        approved: 'Approved',
        pending: 'Pending',
        rejected: 'Rejected',
        external: 'Manual externals',
        responses: '{{count}} responses',
        pinned: 'Pinned',
      },
      overviewTitle: 'Astral Vanguard is preparing Midnight',
      overviewDescription: 'A GM can instantly see who is committed, which wishes still need review, and where the team has roster pressure.',
      rosterTitle: 'Review player wishes before the season starts',
      rosterDescription: 'Officers can compare commitment, main characters, priority wishes, validation state, comments, and roster decisions in one operational table.',
      analyticsTitle: 'What your roster is missing',
      analyticsDescription: 'This demo uses local sample data to show the kind of composition signals Guildforce can surface without another spreadsheet.',
      missingTitle: 'Missing or weak coverage',
      presentTitle: 'Already covered',
      ...
      pollsTitle: 'Polls as a supporting workflow',
      pollsDescription: 'Use targeted polls for raid days, launch-week availability, loot preferences, or bench comfort.',
      pollItems: [
        {
          title: 'Midnight launch availability check',
          status: 'Open',
          description: 'A live roster-wide check for raid nights, launch-week extras, and schedule risk before officers lock the season plan.',
          audience: 'Confirmed raiders and trials in the Midnight Mythic Team',
          resultSummary: 'Wednesday + Sunday currently leads, but several trials still need officer follow-up.',
          sections: [
            {
              title: 'Raid-night commitment',
              description: 'Pin down the default raid schedule before the wishlist lock.',
              questions: [
                {
                  text: 'Which raid nights can you commit to for the first four weeks?',
                  options: ['Wednesday + Sunday', 'Thursday + Sunday', 'Wednesday + Thursday', 'Only one fixed night', 'Still uncertain'],
                },
                {
                  text: 'How stable is your schedule for launch month?',
                  minLabel: 'Not stable',
                  maxLabel: 'Locked in',
                },
                {
                  text: 'What should officers know before locking your raid nights?',
                  comments: [
                    'I can do Wednesday and Sunday, but Thursday is blocked every second week.',
                    'Launch week is clear; after that I need the calendar posted at least a week ahead.',
                    'Happy to sit for progression if the comp needs another immunity.',
                  ],
                },
              ],
            },
            {
              title: 'Launch-week extras',
              description: 'Find volunteers for the non-raid work that usually decides early progression.',
              questions: [
                {
                  text: 'Which launch-week extras can you attend?',
        ...
        {
          title: 'Trial feedback prep',
          status: 'Draft',
          description: 'Officer-only draft for collecting structured notes before trial reviews go live.',
          audience: 'Officers and raid leaders',
          resultSummary: 'Draft preview only. It has not been published to members.',
          sections: [
            {
              title: 'Trial readiness',
              description: 'Keep officer review notes consistent across raid leaders.',
              questions: [
                {
                  text: 'Which trial group needs a review first?',
                  options: ['Ranged DPS', 'Melee DPS', 'Healers', 'Flexible backups'],
                },
                {
                  text: 'Rate current trial readiness for first-week heroic.',
                  minLabel: 'Needs review',
                  maxLabel: 'Ready',
                },
                {
                  text: 'Which notes should be requested from role leads?',
                  options: ['Attendance', 'Mechanics consistency', 'Communication', 'Loot expectations'],
                },
              ],
            },
          ],
        ...
        {
          title: 'Loot, attendance, and bench policy review',
          status: 'Results shared',
          description: 'Closed anonymous survey used by officers to tune policy before progression starts.',
          audience: 'Eligible raiders after wishlist validation',
          resultSummary: 'Members favor roster upgrades first, but bench comfort is split enough to require clearer rules.',
          sections: [
            {
              title: 'Loot policy',
              description: 'Check whether the team understands the launch-week loot tradeoffs.',
              questions: [
                {
                  text: 'Which loot council priority feels fairest for launch week?',
                  options: ['Roster upgrade first', 'Best attendance first', 'Trial catch-up protected', 'Transparent roll fallback'],
                },
                {
                  text: 'Rank the gearing priorities officers should optimize.',
                  options: ['Tier acquisition', 'Weapon crafts', 'Raid consumables', 'Mythic+ score', 'Alt split coverage'],
                },
              ],
            },
            {
              title: 'Bench and attendance',
              description: 'Spot policy areas that need clearer communication.',
              questions: [
                {
                  text: 'How comfortable are you being benched when composition needs it?',
                },
                {
                  text: 'How clear are the current bench rules?',
                  minLabel: 'Unclear',
                  maxLabel: 'Very clear',
                },
                {
                  text: 'What would make loot or bench calls easier to accept?',
                  comments: [
                    'A short note after each raid explaining the comp reason would help.',
                    'Please publish bench priority before invites, not five minutes before pull.',
                    'Loot is fine if the same logic is visible for trials and core raiders.',
                    'I want a clearer path back into the roster after sitting twice.',
                  ],
                },
              ],
            },
      ...
      pollsUi: {
        ...
        closedTab: 'Closed',
        audience: 'Audience',
        responseRate: '{{count}}/{{total}} responded',
        questions: '{{count}} questions',
        sections: '{{count}} sections',
        openPoll: 'Open poll',
        viewResults: 'View results',
        previewDraft: 'Preview draft',
        draftNotice: 'This draft is visible in the demo to show the officer workflow. Publishing and editing are simulated.',
        noPoll: 'Demo poll not found',
        noPollDescription: 'This local demo route does not match an available sample poll.',
        resultsUnavailable: 'Results are available for active polls after a local response and for closed demo polls.',
        responseSavedTitle: 'Demo response saved',
        responseSavedDescription: 'Your answers were stored locally for this demo session.',
        demoOnlyBadge: 'Demo data',
      },
      forumTitle: 'Guild hub preview',
      forumDescription: 'Keep announcements, strategy threads, and roster feedback next to the planning data.',
      forumItems: [
        { title: 'Midnight roster announcement', category: 'Announcements' },
        { title: 'First raid strategy notes', category: 'Strategy' },
        { title: 'Roster feedback before wishlist lock', category: 'Roster' },
      ],
      finalTitle: 'Ready to prepare your Midnight roster?',
      finalDescription: 'Connect Battle.net and create your guild workspace in minutes.',
      continueWithBattleNet: 'Continue with Battle.net',
      backHome: 'Back to homepage',
      actionToastTitle: 'Demo action',
      actionToastDescription: 'The demo does not let you test these actions. Sign in with Battle.net to use Guildforce with your guild!',
    },
    guild: {
      create: 'Create Guild',
      join: 'Join Guild',
    ...
    dashboard: {
      ...
      tokenRiskSummaryMultiple: '{{level}}: {{tokens}} each concentrate {{count}} of {{total}} wishes ({{percent}}%).',

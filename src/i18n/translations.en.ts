...
export const translationsEn: Translations = {
    ...
    dashboard: {
      ...
      tokenMail: 'Mail',
      tokenPlate: 'Plate',
      tokenDistributionInfo: 'A new tier set token distribution is expected for Midnight.',
      tokenDistributionSource: 'See the Wowhead article.',
      ...
      lootConcentrationRisk: 'Loot concentration risk',
      tokenRiskLevels: {
        none: 'No token data',
        low: 'Low risk',

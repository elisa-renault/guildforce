...
export const translationsEn: Translations = {
    ...
    wishes: {
      ...
      removeMember: 'Remove from this season',
      rosterDecision: {
      ...
      memberDetail: {
        ...
        noAssignment: 'No assignment recorded.',
        ...
        no: 'No',
        history: 'History',
        historyEmpty: 'No season history yet.',
        historyEvent: {
          snapshot: 'Member added to roster for the season',
          assignmentChanged: 'Assignment changed',
          assignmentsSeeded: 'Assignment initialized from wishes',
    ...
    dashboard: {
      ...
      rosterTable: {
        ...
        assignmentTooltip: 'Class/spec currently assigned for the season.',

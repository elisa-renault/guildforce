...
export const translationsEn: Translations = {
    ...
    commandPalette: {
      ...
      placeholder: 'Search pages, guilds, members, polls, forum...',
      ...
      actionSubtitles: {
        ...
        createForumTopic: 'Start a topic in the current category',
        openForumFirst: 'Open the forum and choose a category first',
        createAtlasDoc: 'Draft a guild knowledge article',
      },
      pageSubtitles: {
        guilds: 'Switch or manage your guild workspaces',
        forum: 'Topics, posts, moderation, and subscriptions',
    ...
    admin: {
      ...
      stats: {
        ...
        sectionOperationsDesc: 'Forum and moderation workload that needs operational follow-up.',
        ...
        chartCriticalIssuesDesc: 'Open backlog and created-per-day volume for reports, bugs, and deletions.',
        ...
        topicsTooltip: 'Forum discussion threads.',
        postsTooltip: 'Forum replies across all topics.',
        pendingReportsTooltip: 'Reports waiting for moderator action.',
        activeSanctionsTooltip: 'Currently active moderation sanctions.',
        openBugsTooltip: 'Bug reports still marked as open.',
        pendingDeletionsTooltip: 'Account deletion requests awaiting processing.',
        criticalIssuesTooltip: 'Composite count: pending reports + open bugs + pending deletion requests.',

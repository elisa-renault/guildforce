...
export const translationsEn: Translations = {
    ...
    admin: {
      ...
      stats: {
        ...
        chartEngagementTrendDesc: 'WAU/MAU ratio over time with healthy-zone threshold.',
        ...
        engagementRateTooltip: 'Defined as WAU / MAU (weekly active users divided by monthly active users).',

...
export const translationsFr: Translations = {
  ...
  guildVault: {
    ...
    dashboard: {
      ...
      tokenMail: 'Maille',
      tokenPlate: 'Plaque',
      tokenDistributionInfo: 'Une nouvelle distribution des jetons est attendue pour Midnight :',
      tokenDistributionSource: 'l\'article Wowhead.',
      ...
      classesRepresented: 'Classes représentées',
      requestedSpecializations: 'Spécialisations demandées',
      lootConcentrationRisk: 'Risque de concentration loot',
      tokenRiskLevels: {
      ...
      coverageSourceState: '{{count}} source · {{state}}',
      coverageSourceStatePlural: '{{count}} sources · {{state}}',
      coverageSourceCount: '{{count}} source',
      coverageSourceCountPlural: '{{count}} sources',
      coverageStates: {
        missing: 'Manquant',
        covered: 'Couvert',
        secured: 'Sécurisé',

...
export const translationsFr: Translations = {
    ...
    admin: {
      ...
      stats: {
        ...
        forumAdminDesc: 'Gerer les categories, moderateurs, signalements et sanctions',
        uniqueWishUsers: 'Utilisateurs avec voeux',
        totalWishes: 'Total des voeux',
        guildsWithWishes: 'Guildes avec voeux',
        ...
        guildsWithTwoWishUsers: 'Guildes avec 2+ votants de voeux',
        totalPolls: 'Total des sondages',
        activePolls: 'Sondages actifs',
        closedPolls: 'Sondages clotures',
        pollVoters: 'Votants aux sondages',
        groupCommunity: 'Communaute',
        groupWishes: 'Voeux',
        groupForum: 'Forum',
        groupModeration: 'Moderation',
        groupPolls: 'Sondages',
        usersTooltip: 'Total des comptes inscrits.',
        guildsTooltip: 'Guildes creees sur Guildforce.',
        topicsTooltip: 'Sujets de discussion du forum.',
        postsTooltip: "Reponses sur l'ensemble des sujets.",
        pendingReportsTooltip: "Signalements en attente d'action.",
        activeSanctionsTooltip: 'Sanctions actives en cours.',
        openBugsTooltip: 'Bugs encore marques comme ouverts.',
        pendingDeletionsTooltip: 'Demandes de suppression a traiter.',
        uniqueWishUsersTooltip: 'Utilisateurs uniques ayant soumis au moins un voeu.',
        totalWishesTooltip: 'Total des voeux enregistres.',
        guildsWithWishesTooltip: 'Guildes ayant au moins un voeu soumis.',
        engagementRateTooltip: 'Part des utilisateurs ayant soumis des voeux.',
        guildEngagementRateTooltip: 'Part des guildes avec au moins un roster ayant des voeux.',
        guildsWithTwoMembersTooltip: 'Guildes avec au moins deux membres uniques.',
        guildsWithTwoWishUsersTooltip: 'Guildes avec au moins deux utilisateurs uniques ayant soumis des voeux en roster.',
        totalPollsTooltip: 'Total des sondages crees.',
        activePollsTooltip: 'Sondages actuellement ouverts aux reponses.',
        closedPollsTooltip: 'Sondages deja clotures.',
        pollVotersTooltip: 'Utilisateurs uniques ayant repondu a un sondage.'

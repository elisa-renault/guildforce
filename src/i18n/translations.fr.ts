...
export const translationsFr: Translations = {
    ...
    admin: {
      ...
      stats: {
        ...
        chartEngagementTrendDesc: 'Ratio WAU/MAU dans le temps avec zone de seuil saine.',
        ...
        engagementRateTooltip: 'Défini comme WAU / MAU (utilisateurs actifs hebdomadaires divisés par les actifs mensuels).',

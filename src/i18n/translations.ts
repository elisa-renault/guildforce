...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    patchnotes: {
      ...
      components_admin_LegalPagesEditor_language_fr: 'Français',
      ...
      components_admin_PatchNotesEditor_language_fr: 'Français',
      ...
      components_admin_UserManager_role_assigned: 'Rôle {{role}} attribué',
      components_admin_UserManager_role_removed: 'Rôle {{role}} retiré',
      ...
      components_dashboard_ActivityLog_entries: '{{count}} entrées',
      components_dashboard_RosterAnalytics_wish_range: 'Vœux 1-{{n}}',
      ...
      components_polls_PollQuestionEditor_36: 'Rating',
      ...
      export_roles: 'Rôles',
      export_specs: 'Spécialisations',
      export_validation: 'Validation',
      export_wish_label: 'Vœu {{index}}',
      ...
      pages_ForumAdmin_category_name_placeholder: 'Discussion générale',
      ...
      pages_Profile_connected_as: 'Connecté en tant que {{battletag}}',
      ...
      pages_Profile_language_fr: 'Français',
      pages_Profile_not_found: 'Profil introuvable.',
      pages_Profile_select_image_error: 'Veuillez sélectionner un fichier image',
      pages_Profile_setup_success_desc: 'Ton profil a été configuré.',
      pages_Profile_setup_success_title: 'Bienvenue !',
      pages_Profile_update_success_desc: 'Profil mis à jour avec succès !',
      pages_Profile_username_hint: 'C\'est le nom qui sera affiché dans ta guilde',
      pages_Profile_username_placeholder: 'Ton pseudo sur le site',
      pages_Profile_welcome_subtitle: 'Choisis ton pseudo pour être identifié par ta guilde',
  ...
  fr: {
    ...
    auto: {
      ...
      components_polls_PollQuestionEditor_36: 'Avis',
      components_polls_PollQuestionEditor_37: 'Date',

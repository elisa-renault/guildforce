...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    patchnotes: {
      ...
      components_polls_PollResults_response_plural: 'r?ponses',
      components_polls_PollResults_response_single: 'r?ponse',
      ...
      hooks_useGuildPolls_close_error: 'Erreur lors de la cl?ture du sondage',
      hooks_useGuildPolls_close_success: 'Sondage cl?tur?',
      hooks_useGuildPolls_create_error: 'Erreur lors de la cr?ation du sondage',
      hooks_useGuildPolls_delete_error: 'Erreur lors de la suppression du sondage',
      hooks_useGuildPolls_delete_success: 'Sondage supprim?',
      hooks_useGuildPolls_duplicate_error: 'Erreur lors de la duplication du sondage',
      hooks_useGuildPolls_duplicate_suffix: '(copie)',
      hooks_useGuildPolls_publish_error: 'Erreur lors de la publication du sondage',
      hooks_useGuildPolls_publish_success: 'Sondage publi? !',
      hooks_useGuildPolls_questions_update_error: 'Erreur lors de la mise ? jour des questions',
      hooks_useGuildPolls_questions_updated: 'Questions mises ? jour',
      hooks_useGuildPolls_reset_error: 'Erreur lors de la r?initialisation des r?ponses',
      hooks_useGuildPolls_reset_success: 'R?ponses r?initialis?es',
      hooks_useGuildPolls_respondent_rules_error: 'Erreur lors de la sauvegarde du ciblage',
      hooks_useGuildPolls_results_rules_error: 'Erreur lors de la sauvegarde des permissions',
      hooks_useGuildPolls_submit_all_error: 'Erreur lors de l\'envoi des r?ponses',
      hooks_useGuildPolls_submit_all_success: 'R?ponses enregistr?es !',
      hooks_useGuildPolls_submit_response_error: 'Erreur lors de l\'envoi de la r?ponse',
      hooks_useGuildPolls_update_error: 'Erreur lors de la mise ? jour du sondage',
